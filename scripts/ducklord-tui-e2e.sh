...
go test -count=1 ./cmd/ducklord -run "${DUCKLORD_TUI_E2E_PATTERN:-^TestDucklord(WorkspacePreviewContainer|WorkspaceDefaultNewShellSplitContainer|WorkspaceTwoLivePanesContainer|WorkspaceProjectEnterFocusContainer|SharedProjectNotificationContainer|DetailedListContainer|DetailedUnreadFilterContainer|DetailedOfflineContainer|HostRetentionContainer|HostHookConfigContainer|LocalNotificationContainer|ShellFirstHookContainer|ProjectDeleteContainer|ForegroundAgentLabelsContainer|ShellRetirementContainer|ExplicitShellEndRetainsLogContainer|ShellEndModalContainer|DefaultDetachContainer|PaneControlContractContainer|PrefixNavigationContainer|MixedHostProjectContainer)E2E$}" -v
