...
go test -count=1 ./cmd/ducklord -run '^TestDucklord(CreateTUIContainer|WorkspacePreviewContainer|WorkspaceTwoLivePanesContainer|WorkspaceProjectEnterFocusContainer)E2E$' -v
