...
go test -count=1 ./cmd/ducklord -run '^TestDucklord(WorkspacePreviewContainer|WorkspaceTwoLivePanesContainer|WorkspaceProjectEnterFocusContainer|DetailedListContainer|HostRetentionContainer)E2E$' -v
