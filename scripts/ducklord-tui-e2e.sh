...
go test -count=1 ./cmd/ducklord -run "${DUCKLORD_TUI_E2E_PATTERN:-^TestDucklord(WorkspacePreviewContainer|WorkspaceTwoLivePanesContainer|WorkspaceProjectEnterFocusContainer|DetailedListContainer|HostRetentionContainer|HostHookConfigContainer|LocalNotificationContainer|ShellFirstHookContainer|ProjectDeleteContainer)E2E$}" -v
